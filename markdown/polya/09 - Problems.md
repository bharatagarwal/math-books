...
Some problems are old chestnuts. Polya kept them because they are clean, surprising, and teach exactly one thing. A few geometry problems survive because the heuristic they exercise is unusually clear in that setting. The rest come from counting, number theory, and algebra.
...
*Looking back:* the original question -- "how many ways to change a dollar?" -- was isolated and hard. The move was the inventor's paradox: solve the *more general* problem (arbitrary $n$, arbitrary coin sets) and it becomes easier, because you can build recursively from simpler cases. The general problem has structure that the special case hides. Polya's playful withholding of why he chose the letter $E$ -- "a secret of mine which I am not willing to give away at this stage" -- was his way of showing that good notation is part of the discovery: the sequence $A, B, C, D, E$ mirrors the sequence of coin types, and naming it right makes the recurrence almost write itself.
...
|---------|-------------|---------|
| 1 | Examine the condition; question hidden assumptions | Understanding |
| 2 | Do you know a related problem? Reasoning about the sphere | Understanding, Discovery |
| 3 | Restate the problem; find the extremal constraint | Understanding |
| 4 | Solve related simpler problems; preliminary estimate | Discovery |
| 5 | Specialize; guess from small cases; induction | Discovery, Proof and Review |
| 6 | Observe; name the pattern; prove directly | Discovery, Proof and Review |
| 7 | Auxiliary representation (bijection); two proof methods | Auxiliary Problems, Proof and Review |
| 8 | Separate the condition; divisibility decomposition | Understanding, Variation |
| 9 | Introduce notation; decompose conditions into equations | Understanding |
| 10 | Decompose into phases; check extreme cases | Variation, Signs of Progress |
| 11 | Exploit symmetry; work backwards from the answer's form | Auxiliary Problems |
| 12 | Look for structure before computing; combine equations | Discovery, Style |
| 13 | The inventor's paradox; generalize to make it easier | Variation, Auxiliary Problems |
| 14 | The inventor's paradox; generalize the figure | Variation |
| 15 | Separate the condition; algebraic identity trick | Variation, Discovery |
| 16 | Draw a figure; compute cases; verify with Euler's formula | Discovery, Proof and Review |
| 17 | Pigeonhole; notice which extremes coexist | Plausible Reasoning, Proof and Review |
| 18 | Recurrence from boundary analysis; recognize a known sequence | Discovery, Auxiliary Problems |

## Questions to keep

After working these problems -- whether you solved them or not -- carry these questions forward:

- *Which named move did I actually use?* If you cannot name the heuristic, you have not yet filed the experience. The tag after each problem exists for comparison, not prescription.
- *Did I check extreme or boundary cases?* Problems 2, 10, and 15 rewarded this directly. It costs almost nothing and catches errors early.
- *Could I have generalized?* Problems 13 and 14 were easier in their general form than their specific form. When a specific instance resists attack, ask whether a broader statement might be more tractable.
- *Did I look at the structure before computing?* Problems 11, 12, and 15 all had shortcuts that came from noticing symmetry or algebraic relationships first. Brute force always works eventually, but looking first is faster.
- *What would I do differently next time?* The point of practice is not to collect solved problems but to sharpen the self-dialogue. Each problem you work changes what you notice in the next one.
