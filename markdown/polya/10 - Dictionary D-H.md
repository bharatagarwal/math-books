...
![Fig. 16: The triangle reduced to constructing the vertex $A$ on a base $BC = a$, with altitude $h$ and angle $\alpha$ at $A$.](images/f0081-01.jpg)
...
![Fig. 17: A point $P$ on the line $c$ that lies on the parabola with focus $F$ and directrix $d$; the lines $PF$ and $PQ$ (the perpendicular from $P$ to $d$) are equal.](images/f0088-01.jpg)
