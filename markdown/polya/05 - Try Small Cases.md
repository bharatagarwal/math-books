...
The first step is computation. Not clever computation, but brute computation. List every case. Count by hand. The point is not efficiency; the point is *data*.
...
The sums are squares. That alone is interesting. But look at the bases of the squares: $1, 3, 6, 10, 15$. The differences between consecutive bases are $2, 3, 4, 5$. So the bases are triangular numbers, the partial sums $1 + 2 + \cdots + n$. The conjecture:
