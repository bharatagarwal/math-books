...
Drop part (I) instead, specializing it. Fix $n = 3$, $k = 2$, and list: $\{a,b\}$, $\{a,c\}$, $\{b,c\}$. Three. Fix $n = 4$, $k = 2$: six. The numbers $1, 3, 6, 10, \ldots$ appear: triangular numbers. You are building toward $\binom{n}{k}$.
