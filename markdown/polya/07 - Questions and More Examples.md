...
![Fig. 2: A square with three vertices on the perimeter of the triangle (two on the base, one on a side); the fourth corner (red) floats free inside the triangle.](images/ch23-18-fig2-tikz.png)
...
![Fig. 3: Several squares of different sizes, each with three vertices on the perimeter; the free fourth corners (red) suggest a locus.](images/ch23-18-fig3-tikz.png)
...
![Fig. 4: Two angles in different planes, $\angle BAC$ (vertex $A$) and $\angle B'A'C'$ (vertex $A'$), with $AB \parallel A'B'$ and $AC \parallel A'C'$ in the same directions.](images/ch24-19-fig4-tikz.png)
...
![Fig. 5: The auxiliary segments $BC$ and $B'C'$ (dashed) completing two triangles $\triangle ABC$ and $\triangle A'B'C'$, chosen so that $AB = A'B'$ and $AC = A'C'$.](images/ch24-19-fig5-tikz.png)
...
![Fig. 6: A right circular cone, vertex down, of base radius $a$ and altitude $b$; the water forms a smaller similar cone of surface radius $x$ and depth $y$.](images/ch25-20-fig6-tikz.png)
