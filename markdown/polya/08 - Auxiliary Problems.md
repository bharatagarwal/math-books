...
**When it is not worth it.** When you have no reason to believe the detour leads back. When the auxiliary problem is harder than the original. When you have already tried three auxiliary problems and none have panned out, reconsider whether you understood the original problem correctly, rather than casting about for yet another detour.
