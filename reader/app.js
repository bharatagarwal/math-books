const BOOKS = [
  ...
  },
  {
    ...
    basePath: 'polya',
    chapters: [
      { file: '00 - Reading Guide.md', title: 'Reading Guide (for Engineers)' },
      { file: '01 - Prefaces.md', title: 'Prefaces' },
      { file: '02 - How to Solve It.md', title: 'How to Solve It (the summary)' },
      { file: '03 - Foreword.md', title: 'Foreword by John H. Conway' },
      { file: '04 - Introduction.md', title: 'Introduction' },
      { file: '05 - In the Classroom - Purpose.md', title: 'Part I: In the Classroom (§1–5)' },
      { file: '06 - The Four Phases.md', title: 'Part I: The Four Phases (§6–14)' },
      { file: '07 - Questions and More Examples.md', title: 'Part I: Questions & More Examples (§15–20)' },
      { file: '08 - A Dialogue.md', title: 'Part II: A Dialogue' },
      { file: '09 - Dictionary A-C.md', title: 'Part III: Dictionary of Heuristic, A–C' },
      { file: '10 - Dictionary D-H.md', title: 'Part III: Dictionary of Heuristic, D–H' },
      { file: '11 - Dictionary I-P.md', title: 'Part III: Dictionary of Heuristic, I–P' },
      { file: '12 - Dictionary R-S.md', title: 'Part III: Dictionary of Heuristic, R–S' },
      { file: '13 - Dictionary T-W.md', title: 'Part III: Dictionary of Heuristic, T–W' },
      { file: '14 - Problems.md', title: 'Part IV: Problems' },
      { file: '15 - Hints.md', title: 'Part IV: Hints' },
      { file: '16 - Solutions.md', title: 'Part IV: Solutions' },
    ]
  },
  {
