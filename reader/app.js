const BOOKS = [
  {
    ...
    chapters: [
      { file: '01 - What is a Proof.md', title: 'What is a Proof?' },
      { file: '02 - Proof by Contradiction and Induction.md', title: 'Contradiction & Induction' },
      { file: '03 - Invariants and Strong Induction.md', title: 'Invariants & Strong Induction' },
      { file: '04 - Number Theory and the GCD.md', title: 'Number Theory & GCD' },
  ...
  },
  {
    ...
    chapters: [
      ...
      { file: '01 - Counting.md', title: 'Counting' },
      { file: '02 - Probability.md', title: 'Probability' },
      { file: "03 - Bayes' Rule.md", title: "Bayes' Rule" },
      { file: '04 - Logic.md', title: 'Logic' },
      { file: '05 - Proofs.md', title: 'Proofs' },
      { file: '06 - Induction and Recursive Data Types.md', title: 'Induction & Recursion' },
      { file: '07 - Linear Algebra.md', title: 'Linear Algebra' },
      { file: '08 - Linear Algebra 2.md', title: 'Linear Algebra 2' },
      { file: '09 - Graph Theory.md', title: 'Graph Theory' },
      { file: '10 - Number Theory.md', title: 'Number Theory' },
      { file: '11 - Cryptography.md', title: 'Cryptography' },
      { file: '12 - Revision and Problem Solving.md', title: 'Revision & Practice' },
    ]
  },
  {
    id: 'polya',
