const BOOKS = [
  ...
  },
  {
    ...
    chapters: [
      ...
      { file: '01 - Understanding.md', title: 'Understanding' },
      { file: '02 - Discovery.md', title: 'Discovery' },
      { file: '03 - Variation.md', title: 'Variation' },
      { file: '04 - Auxiliary Problems.md', title: 'Auxiliary Problems' },
      { file: '05 - Signs of Progress.md', title: 'Signs of Progress' },
      { file: '06 - Plausible Reasoning.md', title: 'Plausible Reasoning' },
      { file: '07 - Proof and Review.md', title: 'Proof and Review' },
      { file: '08 - Style Judgment and Practice.md', title: 'Style, Judgment, and Practice' },
      { file: '09 - Problems.md', title: 'Problems' },
    ]
  },
  {
